                  ...
                  <div id="menu-harian-table-container">
                    <div class="table-responsive">
                      ...
                      <table class="table table-bordered table-hover mb-0" id="table-kondimen-menu">
                        ...
                        <tbody>
                          <!-- Contoh baris, nanti diisi dinamis via JS -->
                          <tr>
                            <td>1</td>
                            <td>Gulai Taboh</td>
                            <td>pendamping basah</td>
                            <td>475</td>
                            <td><input type="number" class="form-control form-control-sm pembagian-sayur"></td>
                            <td><input type="number" class="form-control form-control-sm hasil-pembagian" readonly></td>
                            <td>
                              <button type="button" class="btn btn-info btn-sm btn-detail-bahan" data-kondimen="1">
                                Detail ▼
                              </button>
                            </td>
                          </tr>

                          <!-- Test coba buat inputan bahan baku -->
                          <!-- Baris detail bahan, hidden awalnya -->
                          <tr class="row-detail-bahan" id="detail-bahan-1" style="display:none;">
                            <td colspan="7">
                              <div class="table-responsive">
                                <table class="table table-sm table-bordered mb-0" id="tabel-bahan-1">
                                  <thead>
                                    <tr>
                                      <th>Bahan Baku</th>
                                      <th>Jumlah Qty</th>
                                  ...
                                  <tbody>
                                    <!-- Baris otomatis dari database/menu -->
                                    <tr>
                                      <td>Jagung</td>
                                    ...
                                    <!-- Baris manual akan ditambah di sini -->
                                  </tbody>
                                </table>
                                <button type="button" class="btn btn-success btn-sm mt-2" onclick="tambahBarisBahan(1)">
                                  + Tambah Bahan
                                </button>
                              </div>
                            </td>
                          </tr>
                          <!-- Ulangi untuk setiap kondimen -->
                        </tbody>
                      </table>
                      <!-- Test coba buat inputan bahan baku -->
                    </div>
