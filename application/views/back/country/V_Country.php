...
<body data-topbar="dark" data-layout="vertical">
          ...
          <div class="row">
            <div class="col-12">
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Country Management</h4>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row align-items-center">
                    <div class="col-md-6">
                      <h4 class="card-title mb-0">Data Country</h4>
                    </div>
                    <div class="col-md-6">
                      <div class="d-flex flex-wrap align-items-center justify-content-end gap-2">
                        <button type="button" class="btn btn-primary btn-tambah-country">
                          <i class="ri-add-circle-line me-1"></i> Tambah Country
                        </button>
                      </div>
                    </div>
                  </div>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                      <thead>
                        <tr>
                          ...
                          <th width="35%">Nama Country</th>
                          <th width="40%">Deskripsi</th>
                          <th width="20%" class="text-center">Action</th>
                        </tr>
                      </thead>
                      <tbody id="show_data_country">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalLabel">Form Country</h5>
        </div>
        <form id="form_country">
          <div class="modal-body">
            ...
            <input type="hidden" id="urutan_tampil" name="urutan_tampil">

            <div class="mb-3">
              <label for="country_nama" class="form-label">Nama Country <span class="text-danger">*</span></label>
              <input type="text" class="form-control" id="country_nama" name="country_nama" placeholder="Masukkan nama country" required>
              <div class="invalid-feedback"></div>
            </div>

            <div class="mb-3">
              <label for="country_deskripsi" class="form-label">Deskripsi</label>
              <textarea class="form-control" id="country_deskripsi" name="country_deskripsi" rows="3" placeholder="Masukkan deskripsi country (opsional)"></textarea>
              <div class="invalid-feedback"></div>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" id="btn_cancel" data-bs-dismiss="modal">Batal</button>
  ...
  <?php $this->load->view('back/country/V_Country_js'); ?>
